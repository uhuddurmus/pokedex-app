...
import { fetchPokemons } from "../../redux/reducer/pokemonsList/pokemonListSlice";
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    minHeight: "205px",
                    background: `linear-gradient(rgba(0,0,0,0.9) 0%, ${value} 70%, ${value} 100%)`,
                    cursor: "pointer",
                  }}
                >
                  <span
